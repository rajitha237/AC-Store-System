...
async def phase4b_two_warehouses(
    client,
    admin_headers,
):
    response = await client.get(
...
@pytest.mark.asyncio
async def test_phase4b_non_serialized_transfer(
    client,
    admin_headers,
    db_session,
):
    ...
    response = await client.post(
        ...
        json={
            ...
            "reference_id":
                "P4B-TRF-301",
            "reason":
                "Branch stock redistribution",
            "notes":
                "Phase 4B standard test",
        },
    )
...
@pytest.mark.asyncio
async def test_phase4b_same_warehouse_rejected(
    client,
    admin_headers,
    db_session,
):
...
@pytest.mark.asyncio
async def test_phase4b_insufficient_stock_rejected(
    client,
    admin_headers,
    db_session,
):
...
@pytest.mark.asyncio
async def test_phase4b_serialized_transfer(
    client,
    admin_headers,
    db_session,
):
    ...
    response = await client.post(
        ...
        json={
            ...
            "reference_id":
                "P4B-TRF-304",
            "reason":
                "Serialized stock redistribution",
            "notes":
                "Phase 4B serialized test",
        },
    )
...
@pytest.mark.asyncio
async def test_phase4b_serialized_wrong_source_rejected(
    client,
    admin_headers,
    db_session,
):
